...
// @namespace    https://github.com/vocauk/bowlroll-english
// @version      0.1
...
(function() {
    ...
    // file
    // some of this page uses JS to get info, so it's not going to be possible to translate for a while
    ...
    let descriptionsDonate, donateBoxes, titles, fileUploadTexts, fileUploadColumns;
    ...
    otherSidebarItems[0].textContent = 'About BowlRoll (Japanese only)';
